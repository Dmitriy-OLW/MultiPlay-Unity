...
namespace Multi.PR1
{
    public class PickupManager : NetworkBehaviour
    {
        ...
        private System.Collections.Generic.Queue<int> _availableHealthSpawnPoints = new System.Collections.Generic.Queue<int>();
        private System.Collections.Generic.Queue<int> _availableAmmoSpawnPoints = new System.Collections.Generic.Queue<int>();
